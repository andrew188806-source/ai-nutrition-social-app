...
Define Supabase project setup for Haocu MVP.

## Why This Matters for Haocu

- Supabase is the core Auth/DB/Storage layer.
- RLS is the primary protection against wrong-user data.
- Seed data powers reliable demo and QA.

## MVP Requirements

- Separate staging/demo/prod Supabase projects.
- Use migrations for schema changes.
- Seed restaurants, menu items, mock users, meal records, chats, group tables, review items.
- Configure role model: user, premium_user, restaurant_owner, admin_reviewer, super_admin.
...
- [ ] Demo seed data reproducible.
- [ ] Role model implemented server-side.
...
| 2 | Create migrations folder | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create seed scripts | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create role tables | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
