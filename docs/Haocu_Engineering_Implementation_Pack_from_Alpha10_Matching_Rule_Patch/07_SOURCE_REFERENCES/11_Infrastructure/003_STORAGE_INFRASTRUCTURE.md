...
Define how Haocu stores and protects photos/files.

## Why This Matters for Haocu

- Meal photos may reveal private lifestyle/location data.
- Restaurant images need approval before public display.
- Admin evidence must never be publicly exposed.

## MVP Requirements

- Use private bucket for meal photos.
- Use signed URLs for private assets.
- Separate profile, restaurant, admin, generated-share, and brand buckets.
- Compress and thumbnail images to reduce cost.
...
- [ ] Meal photos private by default.
- [ ] Restaurant assets public only after approval.
- [ ] Admin evidence private/admin-only.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create bucket policy | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create upload validation | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create thumbnail job | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create asset retention rules | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
