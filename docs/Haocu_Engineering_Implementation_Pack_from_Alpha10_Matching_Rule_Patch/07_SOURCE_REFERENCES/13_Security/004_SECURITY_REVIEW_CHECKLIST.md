...
Provide release checklist for security-sensitive changes.

## Why This Matters for Haocu

- Engineers need a practical checklist before merging risky changes.
- AI, storage, chat, and admin features have special risks.

## MVP Requirements

- Check data exposure, backend enforcement, RLS, secrets, logs, errors, rollback, AI, social/chat, restaurant/admin, storage.
...
- [ ] Checklist covers general/AI/social/admin/storage.
...
|---:|---|---|---|
| 1 | Add checklist to PR template | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Review RLS changes | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Review AI changes | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Review storage changes | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
