...
Protect nutrition, meal photos, social profiles, chats, analytics, and AI processing.

## Why This Matters for Haocu

- Meal photos can reveal identity/location/habits.
- Nutrition data is health-adjacent.
- Location and chat create safety risk.

## MVP Requirements

- Collect only necessary data, keep meal photos private, make real profile visibility explicit, minimize analytics payloads, provide deletion/account controls.
...
- [ ] Sensitive data cataloged.
- [ ] Privacy design rules listed.
- [ ] Analytics exclusions listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create privacy data map | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add consent UI | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Minimize analytics payload | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create deletion path | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
