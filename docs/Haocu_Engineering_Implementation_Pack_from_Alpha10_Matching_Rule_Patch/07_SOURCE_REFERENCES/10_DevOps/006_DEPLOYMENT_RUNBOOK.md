...
Provide step-by-step deployment procedure for Haocu MVP.

## Why This Matters for Haocu

- A repeatable runbook lets engineers deploy without founder-only context.
- Backend, database, AI, and UI releases have different risks.
- Post-deployment smoke tests catch broken core flows quickly.

## MVP Requirements

- Validate CI before deploy.
- Apply migrations safely.
- Deploy Edge Functions with server-only secrets.
...
- [ ] Post-deploy AI/save/Meal Buddy/chat smoke test passes.
...
|---:|---|---|---|
| 1 | Write backend deploy steps | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Write frontend deploy steps | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Write post-deploy smoke test | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Define abort criteria | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
