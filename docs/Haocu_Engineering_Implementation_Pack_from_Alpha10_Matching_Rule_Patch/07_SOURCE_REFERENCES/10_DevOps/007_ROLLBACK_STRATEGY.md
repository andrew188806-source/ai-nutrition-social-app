...
Ensure Haocu can recover from faulty releases without data loss or trust damage.

## Why This Matters for Haocu

- Nutrition, social, and identity bugs can damage trust quickly.
- Database migrations need forward-compatible design.
- AI behavior can regress without code changes.

## MVP Requirements

- Support frontend rollback, backend rollback, feature flag rollback, AI config rollback, and database forward-fix.
- Track prompt/model versions.
- Avoid destructive migrations before beta.
...
- [ ] Feature flag exists for risky flows.
- [ ] AI prompt/model version recorded.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Define rollback matrix | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add AI rollback plan | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add migration compatibility policy | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create hotfix process | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
