...
Define how Haocu verifies quality across AI nutrition, meal records, social matching, restaurants, premium limits, privacy, and demo readiness.

## Why This Matters for Haocu

- Quality means correctable AI, synced meal data, safe social flows, fair premium limits, and clean demos.
- Known bugs from earlier UI/data-flow work must not return.
- QA is part of fundraising readiness.

## MVP Requirements

- Maintain demo script, regression checklist, test matrix, AI QA, Data QA, security/compliance QA, bug triage, and QA backlog.
...
- [ ] P0/P1 severity rules defined.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create demo test script | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create regression checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create AI QA set | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create data QA checks | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
