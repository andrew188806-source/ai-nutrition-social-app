...
Define how acceptance criteria are written for Haocu tasks.

## Why This Matters for Haocu

- Engineers need concrete done criteria.
- AI coding agents need guardrails.
- Product and QA need testable outcomes.

## MVP Requirements

- Use Given/When/Then.
- Include happy, empty, loading, error, permission, analytics, persistence, premium, mobile/web behavior.
...
|---:|---|---|---|
| 1 | Create story template | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create PR checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Map PRD to tasks | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add AC review step | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
