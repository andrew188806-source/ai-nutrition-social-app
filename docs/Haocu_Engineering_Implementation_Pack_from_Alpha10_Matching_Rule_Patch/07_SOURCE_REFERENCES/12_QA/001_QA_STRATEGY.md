...
Build a QA system for MVP user flows, engineering correctness, and investor-demo reliability.

## Why This Matters for Haocu

- AI analysis can be imperfect but must be honest and correctable.
- Meal records must sync across pages.
- Social/chat/group features need safety and identity consistency.

## MVP Requirements

- Use unit, integration, RLS, manual, AI evaluation, regression, and compliance QA layers.
- Prioritize AI->save->recommendation->Meal Buddy->chat path.
...
|---:|---|---|---|
| 1 | Add unit tests | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add integration tests | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add RLS tests | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add manual QA script | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
