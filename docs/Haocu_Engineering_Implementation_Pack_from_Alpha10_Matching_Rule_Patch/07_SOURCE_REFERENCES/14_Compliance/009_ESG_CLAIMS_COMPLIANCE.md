...
Define claim boundaries for future surplus food/supply chain roadmap.

## Why This Matters for Haocu

- ESG and surplus food are future-stage, not current MVP.
- Unsupported impact claims can damage credibility.
- Food safety review is required before surplus/near-expiry operations.

## MVP Requirements

- Frame ESG as roadmap unless built and measured.
- Require evidence for recovered food quantity, partners, handling, discounts, methodology.
- Avoid carbon-neutral/solves-waste claims unless proven.
...
- [ ] MVP vs future scope clear.
- [ ] Risky claims listed.
- [ ] Food safety review points listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Draft ESG claim policy | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create evidence requirements | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Review supply chain roadmap | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Prepare food safety review | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
