...
Define initial retention rules subject to legal review.

## Why This Matters for Haocu

- Meal/photo/chat/admin/audit/payment data have different retention needs.
- Group chat deletion after meal completion must preserve safety exceptions where needed.

## MVP Requirements

- Define retention for accounts, meals, photos, AI logs, chats, group table chat, premium/payment, audit logs, restaurant data, analytics.
- Document deletion request workflow.
...
- [ ] Deferred legal questions listed.
- [ ] Group chat retention noted.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Draft retention policy | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Implement photo deletion | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Implement account deletion request | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Review chat retention | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
