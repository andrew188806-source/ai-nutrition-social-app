...
Translate compliance work into executable tasks.

## Why This Matters for Haocu

- Compliance tasks must not be left until launch week.
- Legal/nutrition/privacy review packages can accelerate professional review.
- MVP must have disclaimers and consent copy.

## MVP Requirements

- Backlog covers privacy, terms, nutrition disclaimer, AI consent, real profile consent, sponsorship labels, restaurant verification language, retention, audit, professional review package.
...
|---:|---|---|---|
| 1 | Create compliance tickets | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Draft legal docs | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Prepare nutrition review | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Prepare privacy review | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
