...
-- Consumer schema draft 014: RLS policy drafts.
...
-- Platform reviewer/admin and service-role policies are intentionally omitted from this draft
-- until security review defines claims, audit, and allowed operation scope.