...
Define row-level security standards for Haocu.

## Why This Matters for Haocu

- Wrong-user data is one of the highest trust risks.
- Client filters are not security.
- Social/chat/group table access needs participant checks.

## MVP Requirements

- Enable RLS on sensitive tables.
- Use owner-only, participant-only, public-approved, role-based, and service-role-only patterns.
...
|---:|---|---|---|
| 1 | Write RLS policies | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Write denied-access tests | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Review role joins | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add policy docs | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
