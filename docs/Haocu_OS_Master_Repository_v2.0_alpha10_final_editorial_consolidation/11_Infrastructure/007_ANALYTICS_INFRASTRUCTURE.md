...
Define analytics pipeline for product, operations, and fundraising metrics.

## Why This Matters for Haocu

- Investor metrics require trustworthy event definitions.
- Analytics must not collect sensitive private content.
- Product-market fit depends on funnel visibility.

## MVP Requirements

- Track activation, AI analysis, meal save, recommendation, Meal Buddy, chat, group table, premium, restaurant, admin events.
- Separate demo/staging from production.
- Avoid raw chat/photo/location payloads.
...
- [ ] Event domains documented.
- [ ] Sensitive payload restrictions listed.
- [ ] Dashboards mapped to KPIs.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create event registry | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add event validation | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create core dashboard | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create investor metric dashboard | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
