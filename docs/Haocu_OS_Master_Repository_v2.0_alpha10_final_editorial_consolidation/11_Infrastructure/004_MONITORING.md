...
Define operational monitoring for reliability, AI performance, safety, and data integrity.

## Why This Matters for Haocu

- Core flows can fail silently without dashboards.
- AI quality and cost require special monitoring.
- Safety and admin queues are operational risks.

## MVP Requirements

- Track app errors, function latency, AI success/cost, meal save, recommendation, Meal Buddy, chat, group table, restaurant admin, moderation queues.
...
- [ ] Monitoring categories documented.
- [ ] P0/P1 thresholds defined.
- [ ] Dashboards mapped to owners.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Add error tracking | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add AI metrics | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add funnel metrics | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add safety queue metrics | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
