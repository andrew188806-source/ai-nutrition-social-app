...
Map features to required test coverage.

## Why This Matters for Haocu

- Different features need different testing depth.
- RLS and social access need negative tests.
- AI needs evaluation beyond normal unit tests.

## MVP Requirements

- Cover AI analysis, meal save, recommendation, Meal Buddy, chat, group table, premium, restaurant admin, admin review, analytics.
- Test free, premium, restaurant owner, admin, empty/new, active/social states.
...
- [ ] Matrix includes unit/integration/manual/RLS/AI columns.
...
|---:|---|---|---|
| 1 | Create test matrix | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add role test data | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add negative tests | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add device matrix | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
