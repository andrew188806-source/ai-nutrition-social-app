...
Define how Haocu classifies and resolves bugs.

## Why This Matters for Haocu

- Not every bug has same risk.
- Demo blockers and trust bugs need fast escalation.
- Repeated bugs need regression tests.

## MVP Requirements

- Classify S0-S3.
- Escalate privacy/security/payment/nutrition/social safety issues.
...
- [ ] Severity table defined.
- [ ] Bug template included.
- [ ] Known high-risk bugs listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create bug labels | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create bug report template | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Define triage meeting | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add regression policy | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
