...
Validate data model behavior and prevent broken identity/sync/permission flows.

## Why This Matters for Haocu

- Data bugs can make UI look correct while product is wrong.
- Meal Buddy and group table identity must use same source.
- Home and nutrition report must not diverge.

## MVP Requirements

- Test user/profile/meal/photo/AI/restaurant/community card/Meal Buddy/match/chat/group/premium/admin relationships.
- Run orphan checks and migration QA.
...
- [ ] Critical relationships documented.
- [ ] Orphan checks listed.
- [ ] Migration QA required.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Add meal sync test | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add identity consistency test | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add orphan checks | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add migration test | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
