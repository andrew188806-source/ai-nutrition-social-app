...
Translate operations requirements into executable tasks.

## Why This Matters for Haocu

- Operations work must be tracked like engineering work.
- P0 runbooks unblock pilots and launches.
- MVP+ automation can follow once manual workflow is proven.

## MVP Requirements

- Backlog covers restaurant onboarding, support, admin review, demo readiness, support severity, moderation, restaurant success, metrics, pilot summary, crowdfunding launch ops.
...
|---:|---|---|---|
| 1 | Create operations tickets | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Assign owners | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create dashboard tasks | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create launch ops tasks | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
