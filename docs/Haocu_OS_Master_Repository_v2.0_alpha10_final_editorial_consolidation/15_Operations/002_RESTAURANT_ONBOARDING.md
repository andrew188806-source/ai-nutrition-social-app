...
Define how restaurants enter Haocu MVP supply and recommendation system.

## Why This Matters for Haocu

- Restaurant data powers database-first AI and recommendations.
- Restaurant partners need clear value.
- Verification/nutrition claims need review.

## MVP Requirements

- Track stages from lead to active/pilot_partner.
- Collect restaurant name, location, cuisine, menu, price, photos, tags, owner/contact.
...
- [ ] Onboarding stages listed.
- [ ] Required data listed.
- [ ] Publishing QA included.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create onboarding form | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create restaurant data checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create claim review | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create restaurant pilot tracker | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
