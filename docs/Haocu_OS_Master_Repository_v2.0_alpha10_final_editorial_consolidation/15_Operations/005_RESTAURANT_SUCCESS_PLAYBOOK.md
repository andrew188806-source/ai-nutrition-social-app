...
Help restaurants get value while maintaining trust and simplicity.

## Why This Matters for Haocu

- Restaurants need clear benefit from data setup.
- Haocu should position as AI-readable discovery and social dining traffic, not just ads.
- Restaurant health metrics support sales.

## MVP Requirements

- Guide restaurants through profile, menu, metadata, metrics, campaigns, and optimization.
- Explain nutrition estimate/source labels.
...
- [ ] Restaurant value messages written.
- [ ] Health metrics listed.
...
|---:|---|---|---|
| 1 | Create restaurant pitch | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create follow-up cadence | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create metrics report | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create campaign checklist | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
