...
Define the operational system for MVP, pilots, restaurant onboarding, support, moderation, and launch.

## Why This Matters for Haocu

- Product success depends on support, admin review, restaurant supply, and metrics.
- Operational gaps become product bugs during launch.
- Clean demo data must be preserved.

## MVP Requirements

- Define functions: user support, restaurant success, admin review, moderation, QA/demo ops, analytics ops, launch ops.
...
|---:|---|---|---|
| 1 | Assign ops owners | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create weekly review | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create demo data owner | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create launch readiness review | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
