...
Define MVP launch, pilot, crowdfunding, and investor-facing release readiness.

## Why This Matters for Haocu

- Launch combines product, engineering, compliance, operations, metrics, restaurant, and support readiness.
- Crowdfunding needs clear story and stable demo.
- Demo freeze prevents last-minute breakage.

## MVP Requirements

- Define stages internal alpha, closed beta, restaurant pilot, crowdfunding/demo launch, public MVP.
- Use pre-launch checklist across product, engineering, compliance, operations.
...
- [ ] Launch stages listed.
- [ ] Pre-launch checklist written.
- [ ] Demo freeze rule included.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create launch checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create crowdfunding ops plan | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create demo freeze | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create post-launch review | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
