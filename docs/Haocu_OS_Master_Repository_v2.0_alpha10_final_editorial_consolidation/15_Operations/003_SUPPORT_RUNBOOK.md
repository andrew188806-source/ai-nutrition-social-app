...
Provide first-line support procedures for common user and restaurant issues.

## Why This Matters for Haocu

- AI inaccuracies, meal sync bugs, quota confusion, and social safety reports need consistent responses.
- Support themes feed product backlog.

## MVP Requirements

- Classify account, AI, meals, recommendation, Meal Buddy, chat/group, safety, restaurant, billing issues.
- Escalate privacy/security/payment/safety and demo blockers quickly.
...
|---:|---|---|---|
| 1 | Create support inbox | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create macros | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create ticket categories | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create escalation flow | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
