...
Convert business planning into execution tasks.

## Operating Principles

- Each task must map to a milestone.
- No task is complete without owner and acceptance criteria.
- Business tasks should not bypass legal/finance review.
- Marketing should not outrun product readiness.

## Requirements

| Area | Decision / Requirement | Review / Acceptance |
|---|---|---|
| Before pitch | Positioning, deck, one-pager, reward cost model. | Ready for review. |
| Before pilot | Interview guide, restaurant intake, dashboard. | Ready to use. |
| Before beta | Pricing test, paid pilot offer, referral loop, investor update. | Ready to run. |
| Before scale | Cohort analysis, premium conversion, restaurant retention. | Measured. |


## Review Checklist

- [ ] P0 tasks are unblocked.
- [ ] Artifacts have owners.
- [ ] Professional review queue linked.
...
|---|---|---|
| P0 | Convert this backlog into project board | P0/P1/P2 labels and owners exist. |
| P0 | Link tasks to repository docs | Every task has source doc. |
| P1 | Schedule weekly business review | Metrics and blockers reviewed. |
