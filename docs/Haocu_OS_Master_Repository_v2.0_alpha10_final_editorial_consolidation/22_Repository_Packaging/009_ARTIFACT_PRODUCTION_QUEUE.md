...
Map source docs to next produced artifacts.

## Operating Principles

- Do not keep expanding repository forever.
- Produce actual artifacts next.
- Every artifact has source docs and output format.
- Professional review before public release.

## Requirements

| Area | Decision / Requirement | Review / Acceptance |
|---|---|---|
| Engineering | GitHub backlog, sprint plan, QA checklist. | Implementation. |
| Legal/finance | Patent packet, trademark packet, finance model, data room. | Review. |
| Fundraising/campaign | Pitch deck, memo, FAQ, crowdfunding page, reward copy, restaurant one-pager, press kit. | External material. |
...
|---|---|---|
| P0 | Select artifact path | A/B/C/D. |
| P0 | Produce first artifact package | Downloadable file. |
