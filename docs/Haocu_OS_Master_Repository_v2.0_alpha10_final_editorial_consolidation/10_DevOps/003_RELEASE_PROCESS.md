...
Define how Haocu moves from development to demo, pilot, beta, and production.

## Why This Matters for Haocu

- Fundraising demos require stable repeatable releases.
- Restaurant pilots need controlled, explainable behavior.
- AI and premium changes require stricter review.

## MVP Requirements

- Classify releases as demo, pilot, migration, AI behavior, compliance-sensitive, or hotfix.
- Run smoke test before external release.
...
|---:|---|---|---|
| 1 | Create release checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create smoke test checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create release notes template | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create demo freeze rule | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
