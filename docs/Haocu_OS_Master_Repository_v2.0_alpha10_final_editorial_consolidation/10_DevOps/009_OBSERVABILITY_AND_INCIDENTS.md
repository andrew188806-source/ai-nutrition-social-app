...
Define monitoring, alerts, and incident response for Haocu.

## Why This Matters for Haocu

- AI analysis, meal save, chat, and restaurant flows need visibility.
- Safety reports and moderation backlog must not disappear.
- Investor demos need early warning of broken core paths.

## MVP Requirements

- Monitor app errors, Edge Function errors, AI cost/latency, meal save failures, chat failures, moderation reports.
- Classify incidents P0-P3.
- Write postmortems for P0/P1.
...
- [ ] Core dashboards defined.
- [ ] P0/P1 escalation documented.
...
| 2 | Add AI cost dashboard | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add funnel dashboard | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create incident playbook | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
