...
Define role-based and object-level authorization.

## Why This Matters for Haocu

- Authentication is not enough; object-level access matters.
- Restaurant owners, admins, users, and premium users have different rights.
- Social objects require participant-level rules.

## MVP Requirements

- Roles: anonymous, user, premium_user, restaurant_owner, admin_reviewer, super_admin.
- Server enforces role, ownership, participant status, premium entitlement, rate limit, feature flag.
...
- [ ] Object-level rules written.
- [ ] Authorization tests identified.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Implement role tables | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Implement ownership checks | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Implement participant checks | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Implement admin checks | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
