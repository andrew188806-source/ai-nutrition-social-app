...
Define controls across collection, storage, processing, sharing, and deletion.

## Why This Matters for Haocu

- Haocu data lifecycle includes photos, meals, AI processing, social display, and analytics.
- Deletion and retention need explicit policy before public launch.

## MVP Requirements

- Explain data requests, separate public/private assets, process AI server-side, sanitize logs, support deletion controls.
...
- [ ] Controls listed.
- [ ] Deletion requirements listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create data lifecycle map | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Add logging redaction | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add deletion request flow | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add retention tags | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
