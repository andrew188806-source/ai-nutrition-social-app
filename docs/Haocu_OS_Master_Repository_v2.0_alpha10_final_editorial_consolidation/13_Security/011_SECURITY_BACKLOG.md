...
Translate security requirements into implementation tasks.

## Why This Matters for Haocu

- Security work must be visible in backlog.
- P0 controls are prerequisites for real users.
- MVP+ hardening follows launch readiness.

## MVP Requirements

- Backlog covers RLS, role access, server-side keys, private storage, chat participant checks, premium entitlement, report/block, audit logs, AI rate limits, incident response.
...
|---:|---|---|---|
| 1 | Create security tickets | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create RLS tests | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create audit log ticket | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create abuse prevention ticket | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
