...
Define MVP security model across mobile, web, Supabase, AI, admin, restaurant, and social systems.

## Why This Matters for Haocu

- Threats include wrong-user data, secret leak, spam/harassment, identity exposure, admin mistakes, unsafe AI claims.
- Startup speed cannot bypass trust.

## MVP Requirements

- Deny by default, server verifies sensitive actions, RLS protects DB, logs avoid private content, admin actions audited.
...
|---:|---|---|---|
| 1 | Create threat model | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create role matrix | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Add audit log design | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Add P0 blockers | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
