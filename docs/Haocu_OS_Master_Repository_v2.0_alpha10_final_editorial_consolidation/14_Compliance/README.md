...
Define boundaries for privacy, nutrition/health claims, ads/sponsorships, restaurant verification, user consent, ESG claims, and professional review.

## Why This Matters for Haocu

- Haocu is food/nutrition information and social dining, not a medical device in MVP.
- Public claims must match what is actually built.
- Professional review is required before launch/fundraising claims.

## MVP Requirements

- Draft privacy/terms/disclaimers, consent points, data retention, nutrition claim rules, sponsorship labels, restaurant verification language, ESG boundaries.
...
- [ ] Medical boundary clear.
- [ ] Consent points identified.
- [ ] Claims requiring review listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Draft privacy policy | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Draft terms | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create disclaimers | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Prepare professional review questions | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
