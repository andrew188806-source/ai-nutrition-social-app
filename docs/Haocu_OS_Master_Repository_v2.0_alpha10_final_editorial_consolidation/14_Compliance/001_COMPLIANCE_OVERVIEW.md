...
Define compliance boundaries and professional review points for Haocu MVP.

## Why This Matters for Haocu

- Privacy, nutrition claims, social safety, restaurant verification, ads, payments, ESG, and IP all intersect with the product.
- Compliance docs help lawyers/nutritionists review faster.

## MVP Requirements

- Disclose estimates, avoid medical positioning, label commercial influence, protect consent, audit trust actions, seek professional review before public claims.
...
- [ ] Compliance domains listed.
- [ ] MVP requirements listed.
- [ ] Professional reviews listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Create compliance checklist | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Assign review owners | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create legal review package | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Create nutrition review package | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
