# Restaurant Verification Compliance
...
Define trust rules for restaurant onboarding, verification, menu/nutrition disclosure, and badges.

## Why This Matters for Haocu

- Blue check/verification must not imply health or government certification.
- Restaurant-provided nutrition needs source labels.
- Admin review decisions need audit logs.

## MVP Requirements

- Use statuses: unclaimed, claimed_pending, verified, rejected, suspended.
- Label nutrition as AI-estimated, restaurant-provided, user-corrected, reviewed/verified if true.
- Audit approvals/rejections.
...
- [ ] Badge meaning defined.
- [ ] Nutrition labels defined.
- [ ] Admin review fields listed.

## Implementation Backlog

| # | Task | Priority | Acceptance Criteria |
|---:|---|---|---|
| 1 | Define verification badge | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 2 | Create review queue | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 3 | Create audit fields | P0 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
| 4 | Review restaurant claims | P1 | Owner assigned, acceptance criteria written, and linked to relevant PRD/Data/API/UI docs. |
