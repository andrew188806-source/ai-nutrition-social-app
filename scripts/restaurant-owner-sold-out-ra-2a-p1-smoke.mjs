#!/usr/bin/env node
// RA-2A-P1 smoke. Executes every contract claim against the frozen migration text and the
// Development acceptance harness. Behavioural proof against a real cluster is the separate
// `test:restaurant-owner-sold-out-ra-2a-p1-postgres` gate; this run is the source contract.
import {
...
const SUITE = "restaurant-owner-sold-out-ra-2a-p1-smoke";
