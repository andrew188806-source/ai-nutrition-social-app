...
try {
  ...
  // Exact successor awareness: the 5 R2B migrations are followed only by the authorized R2E, H3, H4, ADMIN-AE1, ADMIN-B1 and ADMIN-C migrations.
  const AUTHORIZED_TAIL = [...CANDIDATES, "20260919010000_restaurant_owner_branch_menu_item_display_name_draft_visibility_r2e.sql", "20260919020000_staff_management_v2_outer_acl_hardening_h3.sql", "20260919030000_social_interest_lookup_rls_acl_hardening_h4.sql", "20260920010000_admin_operational_read_permissions_ae1.sql", "20260920020000_admin_restaurant_operational_read_foundation_b1.sql", "20260920030000_admin_operational_review_queues_c.sql"];
  check("001. every migration applied; the 5 R2B migrations are followed only by the authorized R2E, H3, H4 and ADMIN-AE1 and ADMIN-B1 migrations, in order",
