...
try {
  ...
  const sr2cNonSuccessorMigrations = repositoryMigrations.filter((f) => !SR2GA_SUCCESSOR_PATHS.includes(`supabase/migrations/${f}`) && !SR2GB_SUCCESSOR_PATHS.includes(`supabase/migrations/${f}`));
