...
try {
  ...
  check("2. lifecycle manifest is the exact SR-2G-E1 successor path set", exact(lifecycle.lifecycleManifest, SR2GE1_SUCCESSOR_PATHS), { expected: SR2GE1_SUCCESSOR_PATHS, actual: lifecycle.lifecycleManifest });
