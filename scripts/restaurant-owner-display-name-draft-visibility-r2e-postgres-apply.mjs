...
try {
  ...
  check("001. every migration applied; total is exactly 138; R2E is followed only by the authorized H3, H4, ADMIN-AE1, ADMIN-B1 and ADMIN-C migrations",
    applied === files.length && files.length === 138 && files.slice(-6).join("|") === ["20260919010000_restaurant_owner_branch_menu_item_display_name_draft_visibility_r2e.sql", "20260919020000_staff_management_v2_outer_acl_hardening_h3.sql", "20260919030000_social_interest_lookup_rls_acl_hardening_h4.sql", "20260920010000_admin_operational_read_permissions_ae1.sql", "20260920020000_admin_restaurant_operational_read_foundation_b1.sql", "20260920030000_admin_operational_review_queues_c.sql"].join("|"),
    { applied, total: files.length, last: files.slice(-6) });
