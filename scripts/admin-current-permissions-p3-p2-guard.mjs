...
check("P3-P1 baseline or one exact local P3-P2 freeze is recognized", candidate || frozen, { head, origin, ahead, behind, status });
...
check("no per-route permission enforcement is introduced", !changed.some((file) => file.startsWith("apps/admin-web/app/admin/") && file !== "apps/admin-web/auth/admin-route-registry.ts"));
