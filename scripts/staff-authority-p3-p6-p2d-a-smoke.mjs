...
test("AM current vocabulary includes bounded P3B/P3C successors", () => assert.deepEqual([...vocabulary.CURRENT_ADMIN_PERMISSION_KEYS], [audit, base, "admin.management.staff.account.write", "admin.management.staff.delegation.write", branch]));
