...
check("79. no DB permission expansion", p3bSuccessor ||
  !/create role|create policy|grant execute|grant update|security definer|role_permissions|alter table\s+public\./i.test(
    changedFromR1.filter((file) => exists(file) && !guardScriptFiles.has(file)
      ...
      && !(p2aPhase && P2A_PATHS.includes(file)) && !(p2bPhase && P2B_PATHS.includes(file))).map(read).join("\n")
  ));
...
const allowedP3Path = (file) => (p2cPhase && P2C_PATHS.includes(file))
  || allowedR2Path(file)
...
const expectedScripts = {
  ...
  ...(p2aPhase ? {
    "test:staff-authority-p3-p6-p2a": "node scripts/staff-authority-p3-p6-p2a-guard.mjs",
    "test:staff-authority-p3-p6-p2a-smoke": "node scripts/staff-authority-p3-p6-p2a-smoke.mjs",
    "test:staff-authority-p3-p6-p2a-mutations": "node scripts/staff-authority-p3-p6-p2a-mutations.mjs"
  } : {}),
  ...(p2bPhase ? {
    "test:staff-authority-p3-p6-p2b": "node scripts/staff-authority-p3-p6-p2b-guard.mjs",
    "test:staff-authority-p3-p6-p2b-smoke": "node scripts/staff-authority-p3-p6-p2b-smoke.mjs",
    "test:staff-authority-p3-p6-p2b-mutations": "node scripts/staff-authority-p3-p6-p2b-mutations.mjs"
  } : {}),
  ...(p2cPhase ? {
    "test:staff-authority-p3-p6-p2c": "node scripts/staff-authority-p3-p6-p2c-guard.mjs",
    "test:staff-authority-p3-p6-p2c-smoke": "node scripts/staff-authority-p3-p6-p2c-smoke.mjs",
    "test:staff-authority-p3-p6-p2c-mutations": "node scripts/staff-authority-p3-p6-p2c-mutations.mjs"
  } : {}),
  ...(p2dAPhase ? {
    "test:staff-authority-p3-p6-p2d-a": "node scripts/staff-authority-p3-p6-p2d-a-guard.mjs",
    "test:staff-authority-p3-p6-p2d-a-smoke": "node scripts/staff-authority-p3-p6-p2d-a-smoke.mjs",
    "test:staff-authority-p3-p6-p2d-a-mutations": "node scripts/staff-authority-p3-p6-p2d-a-mutations.mjs"
  } : {})
};
