...
check("E only bounded P3B-P3F writer keys may enter current application vocabulary", management.every((key) => ["admin.management.staff.account.write", "admin.management.staff.delegation.write", "admin.management.staff.console_admission.write", "admin.management.staff.permission.write"].includes(key) || !fs.readFileSync("apps/admin-web/auth/admin-current-permission-vocabulary.ts", "utf8").includes(`\"${key}\"`)));
...
check("X application vocabulary is exact through bounded P3F", ["196b6ad67dd9398b81d1e5ae9dc2a1951e5477db4aa664a9fad79eb0e308513d", "a19c9415b127792dfe394a9563ad8a0dc8ed0b65923327496540d095eab20b3c", "657b13cdd67ad0b0b72b202a16fef4a34d1da695962e33e706815037282c0df6", "337068a7c2284944589c5d885618afdc52e2f464785e0d81cda28bb4af7217b3", "3f6d4407f867ddce09fc327dfdd3932739a490d147ba8d4d49a33ea2188d8b52"].includes(sha("apps/admin-web/auth/admin-current-permission-vocabulary.ts")));
