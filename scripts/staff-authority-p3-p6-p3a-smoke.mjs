...
check("E no management key enters current application vocabulary", management.every((key) => !fs.readFileSync("apps/admin-web/auth/admin-current-permission-vocabulary.ts", "utf8").includes(`\"${key}\"`)));
...
check("X application vocabulary file is frozen", sha("apps/admin-web/auth/admin-current-permission-vocabulary.ts") === "196b6ad67dd9398b81d1e5ae9dc2a1951e5477db4aa664a9fad79eb0e308513d");
