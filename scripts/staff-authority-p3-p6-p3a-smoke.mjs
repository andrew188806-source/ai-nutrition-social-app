...
check("E only P3B account.write may enter current application vocabulary", management.every((key) => key === "admin.management.staff.account.write" || !fs.readFileSync("apps/admin-web/auth/admin-current-permission-vocabulary.ts", "utf8").includes(`\"${key}\"`)));
...
check("X application vocabulary is exact P3A or bounded P3B successor", ["196b6ad67dd9398b81d1e5ae9dc2a1951e5477db4aa664a9fad79eb0e308513d", "a19c9415b127792dfe394a9563ad8a0dc8ed0b65923327496540d095eab20b3c"].includes(sha("apps/admin-web/auth/admin-current-permission-vocabulary.ts")));
