#!/usr/bin/env node
// RA-2A-P1-R1 smoke. Executes every contract claim against the frozen migration text and the
...
const SUITE = "restaurant-owner-sold-out-preview-ra-2a-p1-r1-smoke";
