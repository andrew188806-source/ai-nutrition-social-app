...
export const ADMIN_PERMISSION_REGISTRY = [
  ...
  { key: "admin.dashboard.counts.read", status: "CURRENT", description: "Read aggregate operational counts (restaurants, branches, menu items by lifecycle and nutrition status) for the Admin dashboard; aggregate only, no row-level data, no other workspace." },
  ...
  { key: "admin.restaurants.read", status: "CURRENT", description: "Read bounded Restaurant Operations projections." },
  ...
  { key: "admin.restaurants.about.read", status: "CURRENT", description: "Read restaurant-provided About content." },
  { key: "admin.restaurants.contact.read", status: "CURRENT", description: "Read bounded restaurant contact projections." },
  { key: "admin.restaurants.menus.read", status: "CURRENT", description: "Read bounded restaurant menu projections." },
  { key: "admin.restaurants.menu.read", status: "CURRENT", description: "Read one Restaurant-scoped menu's detail." },
  { key: "admin.restaurants.menu_item.read", status: "CURRENT", description: "Read one Restaurant-scoped dish/item and its nutrition, ingredients, allergens and certification-status facts." },
  { key: "admin.restaurants.branches.read", status: "CURRENT", description: "Read bounded restaurant branch projections." },
  { key: "admin.restaurants.hours.read", status: "CURRENT", description: "Read branch hours and closures." },
  { key: "admin.restaurants.geo.read", status: "CURRENT", description: "Read restaurant operational GEO, excluding private user GEO." },
  { key: "admin.restaurants.menu_items.read", status: "CURRENT", description: "Read bounded branch-menu-item projections." },
  { key: "admin.restaurants.menu_management.read", status: "CURRENT", description: "Enter the cross-Restaurant menu queue/search workspace; not the canonical owner of Restaurant/Dish facts." },
  { key: "admin.restaurants.menu_management.pending.read", status: "CURRENT", description: "Read pending menu-item quality work." },
  ...
  { key: "admin.restaurants.menu_management.data_quality.read", status: "CURRENT", description: "Read the missing/incomplete Restaurant data queue." },
  ...
  { key: "admin.social.policies.read", status: "CURRENT", description: "Read Social policy metadata." },
  ...
  { key: "admin.nutrition.certification.pending.read", status: "CURRENT", description: "Read the queue of dishes awaiting professional nutrition certification." },
  ...
  { key: "admin.management.read", status: "CURRENT", description: "Enter the Platform Management workspace." },
  { key: "admin.management.staff.read", status: "CURRENT", description: "Read the staff roster and lifecycle detail." },
  { key: "admin.management.roles.read", status: "PLANNED", description: "Read a future governed role catalogue." },
  { key: "admin.management.permissions.read", status: "CURRENT", description: "Read the governed permission catalogue and one staff account's authority." },
...
export const ADMIN_ROUTE_REGISTRY = [
  ...
  // ---------------------------------------------------------------------
  defineRoute({ id: "restaurants", parentId: null, zhTWLabel: "餐廳營運", internalName: "Restaurant Operations", route: "/admin/restaurants", requiredPermissions: ["admin.restaurants.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [{ route: "/menu-review", semantics: "SPLIT" }], navigationVisibility: "ORDINARY", order: 30 }),
  ...
  defineRoute({ id: "menu-management", parentId: "restaurants", zhTWLabel: "跨店菜單工作台", internalName: "Cross-Restaurant Menu Queue", route: "/admin/restaurants/menu-management", requiredPermissions: ["admin.restaurants.menu_management.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 25 }),
  defineRoute({ id: "menu-management-pending", parentId: "menu-management", zhTWLabel: "待新增餐點", internalName: "Pending Menu Items", route: "/admin/restaurants/menu-management/pending", requiredPermissions: ["admin.restaurants.menu_management.pending.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "DATA_CONTENT_QUALITY"], legacyRoutes: [{ route: "/pending-menu-items", semantics: "ONE_TO_ONE" }], navigationVisibility: "ORDINARY", order: 10 }),
  ...
  defineRoute({ id: "menu-management-data-quality", parentId: "menu-management", zhTWLabel: "待補資料", internalName: "Missing/Incomplete Data Queue", route: "/admin/restaurants/menu-management/data-quality", requiredPermissions: ["admin.restaurants.menu_management.data_quality.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "DATA_CONTENT_QUALITY"], legacyRoutes: [{ route: "/data-quality", semantics: "ONE_TO_ONE" }, { route: "/menu-review", semantics: "SPLIT" }, { route: "/tags", semantics: "SPLIT" }], navigationVisibility: "ORDINARY", order: 50 }),

  defineRoute({ id: "restaurant-detail", parentId: "restaurants", zhTWLabel: "餐廳詳情", internalName: "Restaurant Detail", route: "/admin/restaurants/[restaurantId]", requiredPermissions: ["admin.restaurants.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 30 }),
  defineRoute({ id: "restaurant-about", parentId: "restaurant-detail", zhTWLabel: "餐廳介紹", internalName: "Restaurant About", route: "/admin/restaurants/[restaurantId]/about", requiredPermissions: ["admin.restaurants.about.read"], availability: "LIVE", dataClass: "PUBLIC", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 10 }),
  defineRoute({ id: "restaurant-contact", parentId: "restaurant-detail", zhTWLabel: "餐廳聯絡資料", internalName: "Restaurant Contact", route: "/admin/restaurants/[restaurantId]/contact", requiredPermissions: ["admin.restaurants.contact.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 20 }),

  defineRoute({ id: "restaurant-menus", parentId: "restaurant-detail", zhTWLabel: "菜單", internalName: "Restaurant Menus", route: "/admin/restaurants/[restaurantId]/menus", requiredPermissions: ["admin.restaurants.menus.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS", "DATA_CONTENT_QUALITY"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 30 }),
  defineRoute({ id: "restaurant-menu-detail", parentId: "restaurant-menus", zhTWLabel: "菜單詳情", internalName: "Menu Detail", route: "/admin/restaurants/[restaurantId]/menus/[menuId]", requiredPermissions: ["admin.restaurants.menu.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS", "DATA_CONTENT_QUALITY"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 10 }),
  defineRoute({ id: "restaurant-menu-items", parentId: "restaurant-menu-detail", zhTWLabel: "餐點", internalName: "Menu Items", route: "/admin/restaurants/[restaurantId]/menus/[menuId]/items", requiredPermissions: ["admin.restaurants.menu_items.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS", "DATA_CONTENT_QUALITY"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 10 }),
  defineRoute({ id: "restaurant-menu-item-detail", parentId: "restaurant-menu-items", zhTWLabel: "餐點詳情", internalName: "Dish/Item Detail", route: "/admin/restaurants/[restaurantId]/menus/[menuId]/items/[itemId]", requiredPermissions: ["admin.restaurants.menu_item.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS", "DATA_CONTENT_QUALITY"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 10 }),
  defineRoute({ id: "restaurant-item-nutrition", parentId: "restaurant-menu-item-detail", zhTWLabel: "營養資料", internalName: "Item Nutrition Data", route: "/admin/restaurants/[restaurantId]/menus/[menuId]/items/[itemId]/nutrition", requiredPermissions: ["admin.restaurants.menu_item.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 10 }),
  ...
  defineRoute({ id: "restaurant-item-allergens", parentId: "restaurant-menu-item-detail", zhTWLabel: "過敏原", internalName: "Item Allergens", route: "/admin/restaurants/[restaurantId]/menus/[menuId]/items/[itemId]/allergens", requiredPermissions: ["admin.restaurants.menu_item.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 30 }),
  defineRoute({ id: "restaurant-item-certification", parentId: "restaurant-menu-item-detail", zhTWLabel: "營養認證狀態", internalName: "Item Certification Status", route: "/admin/restaurants/[restaurantId]/menus/[menuId]/items/[itemId]/certification", requiredPermissions: ["admin.restaurants.menu_item.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS", "NUTRITION_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 40 }),

  defineRoute({ id: "restaurant-branches", parentId: "restaurant-detail", zhTWLabel: "分店", internalName: "Restaurant Branches", route: "/admin/restaurants/[restaurantId]/branches", requiredPermissions: ["admin.restaurants.branches.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 40 }),
  defineRoute({ id: "restaurant-branch-detail", parentId: "restaurant-branches", zhTWLabel: "分店詳情", internalName: "Branch Detail", route: "/admin/restaurants/[restaurantId]/branches/[branchId]", requiredPermissions: ["admin.restaurants.branches.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 5 }),
  ...
  defineRoute({ id: "restaurant-branch-hours", parentId: "restaurant-branches", zhTWLabel: "營業時間與休業", internalName: "Branch Hours and Closures", route: "/admin/restaurants/[restaurantId]/branches/[branchId]/hours", requiredPermissions: ["admin.restaurants.hours.read"], availability: "LIVE", dataClass: "RESTAURANT_OPERATIONAL", intendedStaffDomains: ["RESTAURANT_OPERATIONS"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 20 }),
  ...
  defineRoute({ id: "management", parentId: null, zhTWLabel: "平台管理", internalName: "Platform Management", route: "/admin/management", requiredPermissions: ["admin_context.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 80 }),
  defineRoute({ id: "management-staff", parentId: "management", zhTWLabel: "人員", internalName: "Staff", route: "/admin/management/staff", requiredPermissions: ["admin_context.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 5 }),
  defineRoute({ id: "management-staff-detail", parentId: "management-staff", zhTWLabel: "人員詳情", internalName: "Staff Detail", route: "/admin/management/staff/[staffAccountId]", requiredPermissions: ["admin_context.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 1 }),
  ...
  defineRoute({ id: "management-permissions", parentId: "management", zhTWLabel: "權限", internalName: "Permissions", route: "/admin/management/permissions", requiredPermissions: ["admin.management.permissions.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT", "AUDIT_SECURITY"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 20 }),
  defineRoute({ id: "management-settings", parentId: "management", zhTWLabel: "設定", internalName: "Settings", route: "/admin/management/settings", requiredPermissions: ["admin_context.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [{ route: "/settings", semantics: "ONE_TO_ONE" }], navigationVisibility: "ORDINARY", order: 30 }),
  defineRoute({ id: "management-security-log", parentId: "management", zhTWLabel: "安全稽核", internalName: "Security Log", route: "/admin/management/security-log", requiredPermissions: ["admin_audit.read"], availability: "LIVE", dataClass: "AUDIT", intendedStaffDomains: ["PLATFORM_MANAGEMENT", "AUDIT_SECURITY"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 40 }),
