...
export const ADMIN_ROUTE_REGISTRY = [
  ...
  defineRoute({ id: "management", parentId: null, zhTWLabel: "平台管理", internalName: "Platform Management", route: "/admin/management", requiredPermissions: ["admin.management.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 80 }),
  defineRoute({ id: "management-staff", parentId: "management", zhTWLabel: "人員", internalName: "Staff", route: "/admin/management/staff", requiredPermissions: ["admin.management.staff.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [], navigationVisibility: "ORDINARY", order: 5 }),
  defineRoute({ id: "management-staff-detail", parentId: "management-staff", zhTWLabel: "人員詳情", internalName: "Staff Detail", route: "/admin/management/staff/[staffAccountId]", requiredPermissions: ["admin.management.staff.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [], navigationVisibility: "CONTEXTUAL", order: 1 }),
  ...
  defineRoute({ id: "management-settings", parentId: "management", zhTWLabel: "設定", internalName: "Settings", route: "/admin/management/settings", requiredPermissions: ["admin.management.read"], availability: "LIVE", dataClass: "SECURITY_AUTH", intendedStaffDomains: ["PLATFORM_MANAGEMENT"], legacyRoutes: [{ route: "/settings", semantics: "ONE_TO_ONE" }], navigationVisibility: "ORDINARY", order: 30 }),
