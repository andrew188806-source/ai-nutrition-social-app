...
//
// Restaurant dishes (see apps/mobile/app/restaurants.tsx: RestaurantDish / restaurantDishes)
...
// never be mixed: a self-made dish must not be injected into restaurantDishes, and a
...
//   SelfMadeDish here when there is no restaurantId, instead of a RestaurantDish.
...
export type SelfMadeDish = {
  ...
  // out of restaurantDishes and out of that restaurant's "均衡推薦" list.
  restaurantId?: string;
