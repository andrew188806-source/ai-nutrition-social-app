// Historical local Group Table prototype. Not imported by normal app routes.
...
import { GroupCalorieSharingCard, GroupTableCalorieUpload, getLatestGroupCalorieShare, type GroupCalorieShare } from "../calorie-sharing";
import { getCommunityCardSettings, getSelectedMascot } from "../community-card-settings";
import { useDemoUserPlan } from "../demo-user-plan";
import { createRestaurantFourPersonTable, getActiveFourPersonTable, updateActiveFourPersonTable, type ActiveFourPersonTable } from "../group-tables";
import { getCommunityProfileByProfileId, resolveCommunityProfileDisplay, type AvatarSource } from "../display-resolvers";
import { createOrOpenGroupTableChat, getMockTableParticipantCandidates } from "../meal-buddy-card";
